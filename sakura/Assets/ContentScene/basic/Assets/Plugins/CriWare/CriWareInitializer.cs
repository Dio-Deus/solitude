...
public class CriAtomConfig {
	...
	/*JP [Android] (ベータ機能）音声再生遅延測定処理を有効にするかどうか */
	public bool androidEnableAudioLatencyCheck = false;
...
public class CriWareInitializer : MonoBehaviour {
	...
	public void Initialize() {
		...
		if (initializesAtom) {
			...
			CriAtomEx.SetAudioLatencyCheckEnabled_ANDROID(atomConfig.androidEnableAudioLatencyCheck);
