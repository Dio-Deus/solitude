	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUI.indentLevel += 1;
		{
			...
			if (showAtomAndroidConfig) {
				...
				GenToggleField("[Beta] Enable Latency Check",    "This enables audio latency check feature. Note that this is a beta feature. Do NOT use this on the final product.", ref initializer.atomConfig.androidEnableAudioLatencyCheck);
				EditorGUI.indentLevel -= 1;
			}
		...
		EditorGUI.indentLevel += 1;
		{
			initializer.decrypterConfig.key = 
				EditorGUILayout.TextField("Key Value", initializer.decrypterConfig.key, GUILayout.MaxWidth(300));	
